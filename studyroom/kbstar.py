...
# 2. 국민은행 간편조회
url = 'https://obank.kbstar.com/quics?page=C025255&cc=b028364:b028702&QSL=F'

driver.get(url)
driver.implicitly_wait(5)

# 2.4 id/pw 입력 후 로그인 버튼 클릭
driver.find_element(By.ID, 'account_num').send_keys('34360204227933')
driver.find_element(By.CLASS_NAME, 'input.s1').click()
driver.find_element(By.CLASS_NAME, 'input.s2').clear()
driver.find_element(By.CLASS_NAME, 'input.s2').send_keys('6473')
...
if __name__ == "__main__":
    #get_balance(34360204227933, 6473, 750224) (계좌번호, 계좌비밀번호, 생년월일6자리)
    ...
    '''
    for i in get_balance(34360204227933, 6473, 750224):
        print(i)
    '''
    bank=34360204227933
    pw=6473
